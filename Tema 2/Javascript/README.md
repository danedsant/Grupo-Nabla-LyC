...
bloque_ejecutar        ::= "{" , "const intN = parseInt(await pedirNumero());" , "const tiempo_inicio = performance.now();" , "let pasos_totales = 0;" , bucle_for_ejecutar , "const tiempo_fin = performance.now();" , "console.log(...);" , "console.log(...);" , "rl.close();" , "}" ;
